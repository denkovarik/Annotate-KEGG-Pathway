...
class allTests(unittest.TestCase):
    ...
    def test_get_pathway_filepaths(self):
        """
        Tests tha ability of the function 'get_pathway_filepaths' to download 
        and save a complete KEGG webpage to the local device in the 
    ...
    def test_ec_in_genome(self):
        """
        Tests the function 'ec_in_genome()' on its ability to 
        determine if an ec number exists in a set of ec numbers from a genome 
        annotation.
