...
## Usage
First downloaded the complete webpage of the KEGG Pathway you want to annotate and save it an a known location. On the KEGG homepage, select 'KEGG PATHWAY'. 
